package com.example.prove2022.config.aspect;
...
//        super(configuration);
//    }
    public ArcusJsonAspect(ArcusConfiguration configuration, ArcusCacheStatsManager arcusCacheStatsManager) {
        super(configuration, arcusCacheStatsManager);
    }
